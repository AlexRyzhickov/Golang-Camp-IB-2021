...
const (
	...
	defaultGatewayURL         = "/responder/v1/"
	...
	defaultConfigFile      = ""
	defaultSecretFile      = ""
	defaultApplicationID   = "responder"
	...
	defaultDaprPublishTopic   = "storage"
	defaultDaprAppPort        = 1250
	defaultDaprSubscribeTopic = "responder"
)
