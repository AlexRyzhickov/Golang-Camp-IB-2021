...
// GormInterface is an autogenerated mock type for the gormInterface type
type GormInterface struct {
	mock.Mock
}

// Delete provides a mock function with given fields: value, conds
func (_m *GormInterface) Delete(value interface{}, conds ...interface{}) *gorm.DB {
	var _ca []interface{}
...
func (_m *GormInterface) Find(dest interface{}, conds ...interface{}) *gorm.DB {
	var _ca []interface{}
	_ca = append(_ca, dest)
	_ca = append(_ca, conds...)
	ret := _m.Called(_ca...)
...
func (_m *GormInterface) FirstOrCreate(dest interface{}, conds ...interface{}) *gorm.DB {
	var _ca []interface{}
	_ca = append(_ca, dest)
	_ca = append(_ca, conds...)
	ret := _m.Called(_ca...)
...
func (_m *GormInterface) Model(value interface{}) *gorm.DB {
	ret := _m.Called(value)
...
func (_m *GormInterface) Updates(values interface{}) *gorm.DB {
...
func (_m *GormInterface) Where(query interface{}, args ...interface{}) *gorm.DB {
	var _ca []interface{}
